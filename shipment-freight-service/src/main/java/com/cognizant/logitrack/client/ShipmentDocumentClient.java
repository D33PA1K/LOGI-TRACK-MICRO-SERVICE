...
@FeignClient(name = "compliance-doc-service", contextId = "ShipmentDocumentClient", path = "/api/shipment-documents", fallbackFactory = ShipmentDocumentClientFallbackFactory.class)
