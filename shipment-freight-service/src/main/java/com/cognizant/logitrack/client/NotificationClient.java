...
@FeignClient(name = "notification-alert-service", contextId = "NotificationClient", path = "/api/notifications", fallbackFactory = NotificationClientFallbackFactory.class)
